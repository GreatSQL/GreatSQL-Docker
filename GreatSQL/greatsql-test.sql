...
SELECT IF(PLUGIN_NAME="turbo", "OK, SUPPORT Turbo ENGINE", "NG, NOT SUPPORT Turbo ENGINE") AS '4.1 check: Turbo ENGINE' FROM information_schema.PLUGINS WHERE PLUGIN_NAME='turbo' AND PLUGIN_STATUS='ACTIVE';
SELECT '                 ' FROM DUAL;
...
USE mysql;
SOURCE /usr/local/GreatSQL/share/audit_log_filter_linux_install.sql
